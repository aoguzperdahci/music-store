            ...
            <Carousel className='background'>
                <Carousel.Item>
                    <Row>
                        ...
                        <h3 className='heading'>Discount On Every Piano</h3>
                        <div>
                        <p className='text'>Up to 15% - 25% discount on all piano brands on your first purchase from our website.
                        Do not miss our campaign that is valid until the end of this January. Do not forget it is limited edition.
                       
                        </p> 
                        </div>
                        <Image className='img-size' src={pianobrandsImage}></Image>
                        </Col>
                ...
                <Carousel.Item>
                    <Row>
                        <Col lg={4} className='d-none d-lg-block text-center my-auto'>
                        <h3 className='heading'>Best Ukulele Brands Are Back In Stock</h3>
                        <p className='text'>The most preferred models and brands all over the world are at your fingertips
                ...
                <Carousel.Item>
                    <Row>
                        <Col lg={4} className='d-none d-lg-block text-center my-auto'>
                        <h3 className='heading'>Everything You Are Looking For</h3>
                        <p className='text'>Many instrumental stuff are finally available again! Every little instrumental 
                        tool you are in need is on this website. We have renewed our stocks! Check out for the newest products. </p>
                        <Image className='img-size' src={brandsImage}></Image>
                        </Col>
                        <Col lg={8}>
                            <img
                                className="crsl-img"
